...
def cartesia_text_to_speech(text: str, language_code: str = "en") -> str:
    """Converts text to speech using Cartesia and saves as WAV."""
    client = Cartesia(api_key=os.environ["CARTESIA_API_KEY"])
 
    generator = client.tts.bytes(
        model_id="sonic-multilingual",  # switched from sonic-english
        transcript=text,
        language=language_code,         # now passed in from app.py
